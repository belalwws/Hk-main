...
npm run dev:editor       # تشغيل المحرر المتقدم
...
- **محرر متعدد الملفات** - HTML, CSS, JS, JSON
- **مكتبة أكواد مساعدة** - snippets للتسجيل والتأثيرات
- **معرض قوالب جاهزة** - تصاميم متنوعة وعصرية
- **معاينة متجاوبة** - Desktop/Tablet/Mobile
- **تكامل تلقائي** - ربط مع نظام التسجيل

### الاستخدام

1. انقر **"معرض القوالب"** لاختيار تصميم جاهز
2. استخدم **"مكتبة الأكواد"** لإضافة مكونات
3. عدّل الكود في المحرر المتعدد الملفات
4. اختبر النتيجة في **"المعاينة"**
5. احفظ وفعّل الصفحة

📖 **دليل مفصل**: راجع `ADVANCED_EDITOR_GUIDE.md`
...
📖 **دليل الحماية**: راجع `DATA_PROTECTION_FIX.md`
